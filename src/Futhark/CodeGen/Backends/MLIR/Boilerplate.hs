...
module Futhark.CodeGen.Backends.MLIR.Boilerplate
  ( generateBoilerplate,
    profilingEvent,
    copyDevToDev,
    copyDevToHost,
...
import Futhark.CodeGen.MLIR.Heuristics
...
openClDecls cost_centres kernels metal_program =
  (ctx_fields, ctx_inits, metal_boilerplate, metal_load)
  where
    metal_program_fragments =
...
commonOptions =
  [ Option
      { optionLongName = "device",
        ...
        optionDescription = "Use the first metal device whose name contains the given string.",
    ...
    Option
      { optionLongName = "default-group-size",
        ...
        optionDescription = "The default size of metal workgroups that are launched.",
    ...
    Option
      { optionLongName = "default-num-groups",
        optionShortName = Nothing,
        optionArgument = RequiredArgument "INT",
        optionDescription = "The default number of metal workgroups that are launched.",
