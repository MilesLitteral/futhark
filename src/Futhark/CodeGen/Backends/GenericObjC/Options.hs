...
import Data.Maybe
import qualified Language.ObjC.Quote.ObjC as ObjC
...
generateOptionParser :: String -> [Option] -> ObjC.Func
generateOptionParser fname options =
  [ObjC.cfun|int $id:fname(struct futhark_context_config *cfg, int argc, char* const argv[]) {
