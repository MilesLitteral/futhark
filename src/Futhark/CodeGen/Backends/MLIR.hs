...
-- | Code generation for C with MLIR.
...
-- | Compile the program to C with calls to MLIR.
  ...
  commonOptions
    ++ [ Option
           { optionLongName = "platform",
             ...
             optionDescription = "Use the first MLIR platform whose name contains the given string.",
             optionAction = [C.cstm|futhark_context_config_set_platform(cfg, optarg);|]
           },
         Option
           { optionLongName = "dump-mlir",
             optionShortName = Nothing,
             optionArgument = RequiredArgument "FILE",
             optionDescription = "Dump the embedded MLIR program to the indicated file.",
             optionAction =
               [C.cstm|{futhark_context_config_dump_program_to(cfg, optarg);
                                     entry_point = NULL;}|]
           },
         Option
           { optionLongName = "load-mlir",
             optionShortName = Nothing,
             optionArgument = RequiredArgument "FILE",
             optionDescription = "Instead of using the embedded MLIR program, load it from the indicated file.",
             optionAction = [C.cstm|futhark_context_config_load_program_from(cfg, optarg);|]
           },
         Option
           { optionLongName = "dump-mlirl-binary",
             optionShortName = Nothing,
             optionArgument = RequiredArgument "FILE",
             optionDescription = "Dump the compiled version of the embedded MLIR program to the indicated file.",
             optionAction =
               [C.cstm|{futhark_context_config_dump_binary_to(cfg, optarg);
                                     entry_point = NULL;}|]
           },
         Option
           { optionLongName = "load-mlir-binary",
             optionShortName = Nothing,
             optionArgument = RequiredArgument "FILE",
             optionDescription = "Load an MLIR binary from the indicated file.",
         ...
         Option
           { optionLongName = "list-devices",
             optionShortName = Nothing,
             optionArgument = NoArgument,
             optionDescription = "List all MLIR devices and platforms available on the system.",
             optionAction =
...
-- unnecessary "synchronisation" of the MLIR command queue, and
...
writeMetalScalar :: GC.WriteScalar MLIR ()
...
readMetalScalar :: GC.ReadScalar MLIR ()
...
allocateMetalBuffer :: GC.Allocate MLIR ()
...
deallocateMetalBuffer :: GC.Deallocate MLIR ()
...
metalMemoryType :: GC.MemoryType MLIR ()
...
staticMetalArray :: GC.StaticArray MLIR ()
...
staticMetalArray _ space _ _ =
  error $ "MLIR backend cannot create static array in memory space '" ++ space ++ "'"

callKernel :: GC.OpCompiler MLIR ()
