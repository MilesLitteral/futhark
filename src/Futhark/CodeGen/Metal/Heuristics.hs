...
data SizeHeuristic = SizeHeuristic
  { platformName :: String,
    ...
    heuristicValue :: TPrimExp Int16 DeviceInfo
  }

-- | All of our heuristics.
sizeHeuristicsTable :: [SizeHeuristic]
sizeHeuristicsTable =
  [ SizeHeuristic "Metal M1 GPU" DeviceGPU LockstepWidth 16,
  ...
  where
    max_compute_units =
      TPrimExp $ LeafExp (DeviceInfo "MAX_COMPUTE_UNITS") $ IntType Int16
